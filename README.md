...
Identified null values using isnull() and column-wise inspection.

Applied multiple imputation techniques based on business logic:
...
Recomputed Conversion Rate using:
...
Predictive modeling or machine learning workflows
